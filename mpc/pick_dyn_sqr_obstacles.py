...
def generate_pathplanner(create=True, path=''):
    ...
    model.hl = np.array([0.05 + 0.05, 0.05 + 0.05,       0])
    ...
    # Set solver options
    codeoptions = forcespro.CodeOptions('FORCESNLPsolver1')
    ...
    if create:
        ...
        solver = forcespro.nlp.Solver.from_directory(path + "FORCESNLPsolver1")
