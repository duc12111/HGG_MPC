...
a Python wrapper for a fast solver generated by FORCESPRO v6.0.0
   ...
   OUTPUT = FORCESNLPsolver2_py.FORCESNLPsolver2_solve(PARAMS) solves a multistage problem
   ...
   [OUTPUT, EXITFLAG] = FORCESNLPsolver2_py.FORCESNLPsolver2_solve(PARAMS) returns additionally
   ...
   [OUTPUT, EXITFLAG, INFO] = FORCESNLPsolver2_py.FORCESNLPsolver2_solve(PARAMS) returns 
...
#_lib = ctypes.CDLL(os.path.join(os.getcwd(),'FORCESNLPsolver2/lib/FORCESNLPsolver2.so')) 
try:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolver2/lib/FORCESNLPsolver2_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolver2_solve')
except:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolver2/lib/libFORCESNLPsolver2_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolver2_solve')

internal_mem = getattr(_lib,'FORCESNLPsolver2_internal_mem')

class FORCESNLPsolver2_params_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESNLPsolver2_params = {'xinit' : np.array([]),
'x0' : np.array([]),
...
FORCESNLPsolver2_params_types = {'xinit' : np.float64,
'x0' : np.float64,
'all_parameters' : np.float64,
}

class FORCESNLPsolver2_outputs_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESNLPsolver2_outputs = {'x1' : np.array([]),
'x2' : np.array([]),
'x3' : np.array([]),
'x4' : np.array([]),
'x5' : np.array([]),
...
class FORCESNLPsolver2_info(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
class FORCESNLPsolver2_mem(ctypes.Structure):
    pass
...
csolver.argtypes = ( ctypes.POINTER(FORCESNLPsolver2_params_ctypes), ctypes.POINTER(FORCESNLPsolver2_outputs_ctypes), ctypes.POINTER(FORCESNLPsolver2_info), ctypes.POINTER(FORCESNLPsolver2_mem), ctypes.POINTER(FILE))
csolver.restype = ctypes.c_int

internal_mem.argtypes = [ctypes.c_uint]
internal_mem.restype = ctypes.POINTER(FORCESNLPsolver2_mem)

def FORCESNLPsolver2_solve(params_arg):
    '''
a Python wrapper for a fast solver generated by FORCESPRO v6.0.0
 ...
 See also COPYING
    ...
    # convert parameters
    params_py = FORCESNLPsolver2_params_ctypes()
    for par in params_arg:
        try:
            ...
            if isinstance(getattr(params_py, par), ctypes.Array):
                params_arg[par] = np.require(params_arg[par], dtype=FORCESNLPsolver2_params_types[par], requirements='F')
    ...
    outputs_py = FORCESNLPsolver2_outputs_ctypes()
    info_py = FORCESNLPsolver2_info()
    if sys.version_info.major == 2:
        ...
        try:
            PyFile_AsFile.restype = ctypes.POINTER(FILE)
            exitflag = _lib.FORCESNLPsolver2_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), PyFile_AsFile(fp) , _lib.FORCESNLPsolver2_adtool2forces )
        ...
        try:
            if sys.platform.startswith('win'):
                exitflag = _lib.FORCESNLPsolver2_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), None , _lib.FORCESNLPsolver2_adtool2forces)
            else:
                exitflag = _lib.FORCESNLPsolver2_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), fp , _lib.FORCESNLPsolver2_adtool2forces)
            libc.fclose(fp)
    ...
    # convert outputs
    for out in FORCESNLPsolver2_outputs:
        FORCESNLPsolver2_outputs[out] = npct.as_array(getattr(outputs_py,out))

    return FORCESNLPsolver2_outputs,int(exitflag),info_py

solve = FORCESNLPsolver2_solve
