...
#include "../include/FORCESNLPsolver2_memory.h"
...
static FORCESNLPsolver2_params params;
static FORCESNLPsolver2_output output;
static FORCESNLPsolver2_info info;
static FORCESNLPsolver2_mem * mem;
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1)
	{
		mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help FORCESNLPsolver2_mex' for details.");
	}    
	if (nlhs > 3) 
	{
    ...
    if (mem == NULL)
    {
        mem = FORCESNLPsolver2_internal_mem(0);
    }
	...
	#if SET_PRINTLEVEL_FORCESNLPsolver2 > 0
	...
	exitflag = FORCESNLPsolver2_solve(&params, &output, &info, mem, fp, pt2function_FORCESNLPsolver2);
