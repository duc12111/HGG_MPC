/*
FORCESNLPsolver2 : A fast customized optimization solver.
...
typedef FORCESNLPsolver2_float solver_float;
...
void copyCArrayToM_FORCESNLPsolver2(FORCESNLPsolver2_float *src, double *dest, solver_int32_default dim) 
{
...
void copyCValueToM_FORCESNLPsolver2(FORCESNLPsolver2_float* src, double* dest)
{
    *dest = (double)*src;
}

void copyMArrayToC_FORCESNLPsolver2(double *src, FORCESNLPsolver2_float *dest, solver_int32_default dim) 
{
    solver_int32_default i;
    for( i = 0; i < dim; i++ ) 
    {
        *dest++ = (FORCESNLPsolver2_float) (*src++) ;
    }
}

void copyMValueToC_FORCESNLPsolver2(double * src, FORCESNLPsolver2_float * dest)
{
	*dest = (FORCESNLPsolver2_float) *src;
}
...
extern solver_int32_default (FORCESNLPsolver2_float *x, FORCESNLPsolver2_float *y, FORCESNLPsolver2_float *l, FORCESNLPsolver2_float *p, FORCESNLPsolver2_float *f, FORCESNLPsolver2_float *nabla_f, FORCESNLPsolver2_float *c, FORCESNLPsolver2_float *nabla_c, FORCESNLPsolver2_float *h, FORCESNLPsolver2_float *nabla_h, FORCESNLPsolver2_float *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
FORCESNLPsolver2_extfunc pt2function_FORCESNLPsolver2 = &;
...
void mexFunction( solver_int nlhs, mxArray *plhs[], solver_int nrhs, const mxArray *prhs[] )  
{
    ...
    arr = prhs[0];
    copyMArrayToC_FORCESNLPsolver2(mxGetPr(arr), z, nvar);
    if (nrhs > 1)
	{
        arr = prhs[1];
        if ( !mxIsEmpty(arr) )
        {
            copyMArrayToC_FORCESNLPsolver2(mxGetPr(arr), p, dimp);
        }
	}   
	...
	copyCArrayToM_FORCESNLPsolver2(obj, mxGetPr(obj_mex), 1);
	copyCArrayToM_FORCESNLPsolver2(jacobj, mxGetPr(gradobj_mex), nvar);
	plhs[0] = obj_mex;
	plhs[1] = gradobj_mex;
