 ...
 *  - FORCESNLPsolver3
 *  - "include/FORCESNLPsolver3.h"
 *  - FORCESNLPsolver3_adtool2forces
 *  - FORCESNLPsolver3_interface
 *
...
#define SOLVER_FLOAT CONCATENATE(FORCESNLPsolver3, _float)
#define SOLVER_FUN_NAME CONCATENATE(FORCESNLPsolver3, _solve)

#include "include/FORCESNLPsolver3.h"

/* Header of external evaluation function */
solver_int32_default FORCESNLPsolver3_adtool2forces(SOLVER_FLOAT *x, SOLVER_FLOAT *y, SOLVER_FLOAT *l,
...
int FORCESNLPsolver3_interface(void *params, void *outputs, void *info, void *mem, FILE *fp) {
    return SOLVER_FUN_NAME(params, outputs, info, mem, fp, &FORCESNLPsolver3_adtool2forces);
}
