...
#include "../include/FORCESNLPsolver3_memory.h"
...
static FORCESNLPsolver3_params params;
static FORCESNLPsolver3_output output;
static FORCESNLPsolver3_info info;
static FORCESNLPsolver3_mem * mem;
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1)
	{
		mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help FORCESNLPsolver3_mex' for details.");
	}    
	if (nlhs > 3) 
	{
    ...
    if (mem == NULL)
    {
        mem = FORCESNLPsolver3_internal_mem(0);
    }
	...
	#if SET_PRINTLEVEL_FORCESNLPsolver3 > 0
	...
	exitflag = FORCESNLPsolver3_solve(&params, &output, &info, mem, fp, pt2function_FORCESNLPsolver3);
