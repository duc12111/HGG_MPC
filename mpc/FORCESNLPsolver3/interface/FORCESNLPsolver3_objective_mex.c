...
typedef FORCESNLPsolver3_float solver_float;
...
void copyCArrayToM_FORCESNLPsolver3(FORCESNLPsolver3_float *src, double *dest, solver_int32_default dim) 
{
...
void copyCValueToM_FORCESNLPsolver3(FORCESNLPsolver3_float* src, double* dest)
{
    *dest = (double)*src;
}

void copyMArrayToC_FORCESNLPsolver3(double *src, FORCESNLPsolver3_float *dest, solver_int32_default dim) 
{
    solver_int32_default i;
    for( i = 0; i < dim; i++ ) 
    {
        *dest++ = (FORCESNLPsolver3_float) (*src++) ;
    }
}

void copyMValueToC_FORCESNLPsolver3(double * src, FORCESNLPsolver3_float * dest)
{
	*dest = (FORCESNLPsolver3_float) *src;
}
...
extern solver_int32_default (FORCESNLPsolver3_float *x, FORCESNLPsolver3_float *y, FORCESNLPsolver3_float *l, FORCESNLPsolver3_float *p, FORCESNLPsolver3_float *f, FORCESNLPsolver3_float *nabla_f, FORCESNLPsolver3_float *c, FORCESNLPsolver3_float *nabla_c, FORCESNLPsolver3_float *h, FORCESNLPsolver3_float *nabla_h, FORCESNLPsolver3_float *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
FORCESNLPsolver3_extfunc pt2function_FORCESNLPsolver3 = &;
...
void mexFunction( solver_int nlhs, mxArray *plhs[], solver_int nrhs, const mxArray *prhs[] )  
{
    ...
    arr = prhs[0];
    copyMArrayToC_FORCESNLPsolver3(mxGetPr(arr), z, nvar);
    if (nrhs > 1)
	{
        arr = prhs[1];
        if ( !mxIsEmpty(arr) )
        {
            copyMArrayToC_FORCESNLPsolver3(mxGetPr(arr), p, dimp);
        }
	}   
	...
	copyCArrayToM_FORCESNLPsolver3(obj, mxGetPr(obj_mex), 1);
	copyCArrayToM_FORCESNLPsolver3(jacobj, mxGetPr(gradobj_mex), nvar);
	plhs[0] = obj_mex;
	plhs[1] = gradobj_mex;
