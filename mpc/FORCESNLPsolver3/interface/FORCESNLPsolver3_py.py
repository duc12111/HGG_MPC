...
a Python wrapper for a fast solver generated by FORCESPRO v6.0.0
   ...
   OUTPUT = FORCESNLPsolver3_py.FORCESNLPsolver3_solve(PARAMS) solves a multistage problem
   subject to the parameters supplied in the following dictionary:
       ...
       PARAMS['all_parameters'] - column vector of length 192
   ...
   [OUTPUT, EXITFLAG] = FORCESNLPsolver3_py.FORCESNLPsolver3_solve(PARAMS) returns additionally
   ...
   [OUTPUT, EXITFLAG, INFO] = FORCESNLPsolver3_py.FORCESNLPsolver3_solve(PARAMS) returns 
...
#_lib = ctypes.CDLL(os.path.join(os.getcwd(),'FORCESNLPsolver3/lib/FORCESNLPsolver3.so')) 
try:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolver3/lib/FORCESNLPsolver3_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolver3_solve')
except:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolver3/lib/libFORCESNLPsolver3_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolver3_solve')

internal_mem = getattr(_lib,'FORCESNLPsolver3_internal_mem')

class FORCESNLPsolver3_params_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESNLPsolver3_params = {'xinit' : np.array([]),
'x0' : np.array([]),
...
FORCESNLPsolver3_params_types = {'xinit' : np.float64,
'x0' : np.float64,
'all_parameters' : np.float64,
}

class FORCESNLPsolver3_outputs_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESNLPsolver3_outputs = {'x1' : np.array([]),
'x2' : np.array([]),
'x3' : np.array([]),
'x4' : np.array([]),
'x5' : np.array([]),
...
class FORCESNLPsolver3_info(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
class FORCESNLPsolver3_mem(ctypes.Structure):
    pass
...
csolver.argtypes = ( ctypes.POINTER(FORCESNLPsolver3_params_ctypes), ctypes.POINTER(FORCESNLPsolver3_outputs_ctypes), ctypes.POINTER(FORCESNLPsolver3_info), ctypes.POINTER(FORCESNLPsolver3_mem), ctypes.POINTER(FILE))
csolver.restype = ctypes.c_int

internal_mem.argtypes = [ctypes.c_uint]
internal_mem.restype = ctypes.POINTER(FORCESNLPsolver3_mem)

def FORCESNLPsolver3_solve(params_arg):
    '''
a Python wrapper for a fast solver generated by FORCESPRO v6.0.0
 ...
 See also COPYING
    ...
    # convert parameters
    params_py = FORCESNLPsolver3_params_ctypes()
    for par in params_arg:
        try:
            ...
            if isinstance(getattr(params_py, par), ctypes.Array):
                params_arg[par] = np.require(params_arg[par], dtype=FORCESNLPsolver3_params_types[par], requirements='F')
    ...
    outputs_py = FORCESNLPsolver3_outputs_ctypes()
    info_py = FORCESNLPsolver3_info()
    if sys.version_info.major == 2:
        ...
        try:
            PyFile_AsFile.restype = ctypes.POINTER(FILE)
            exitflag = _lib.FORCESNLPsolver3_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), PyFile_AsFile(fp) , _lib.FORCESNLPsolver3_adtool2forces )
        ...
        try:
            if sys.platform.startswith('win'):
                exitflag = _lib.FORCESNLPsolver3_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), None , _lib.FORCESNLPsolver3_adtool2forces)
            else:
                exitflag = _lib.FORCESNLPsolver3_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), fp , _lib.FORCESNLPsolver3_adtool2forces)
            libc.fclose(fp)
    ...
    # convert outputs
    for out in FORCESNLPsolver3_outputs:
        FORCESNLPsolver3_outputs[out] = npct.as_array(getattr(outputs_py,out))

    return FORCESNLPsolver3_outputs,int(exitflag),info_py

solve = FORCESNLPsolver3_solve
