 ...
 *  - FORCESNLPsolver1
 *  - "include/FORCESNLPsolver1.h"
 *  - FORCESNLPsolver1_adtool2forces
 *  - FORCESNLPsolver1_interface
 *
...
#define SOLVER_FLOAT CONCATENATE(FORCESNLPsolver1, _float)
#define SOLVER_FUN_NAME CONCATENATE(FORCESNLPsolver1, _solve)

#include "include/FORCESNLPsolver1.h"

/* Header of external evaluation function */
solver_int32_default FORCESNLPsolver1_adtool2forces(SOLVER_FLOAT *x, SOLVER_FLOAT *y, SOLVER_FLOAT *l,
...
int FORCESNLPsolver1_interface(void *params, void *outputs, void *info, void *mem, FILE *fp) {
    return SOLVER_FUN_NAME(params, outputs, info, mem, fp, &FORCESNLPsolver1_adtool2forces);
}
