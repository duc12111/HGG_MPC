...
#include "../include/FORCESNLPsolver1_memory.h"
...
static FORCESNLPsolver1_params params;
static FORCESNLPsolver1_output output;
static FORCESNLPsolver1_info info;
static FORCESNLPsolver1_mem * mem;
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1)
	{
		mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help FORCESNLPsolver1_mex' for details.");
	}    
	if (nlhs > 3) 
	{
    ...
    if (mem == NULL)
    {
        mem = FORCESNLPsolver1_internal_mem(0);
    }
	...
	#if SET_PRINTLEVEL_FORCESNLPsolver1 > 0
	...
	exitflag = FORCESNLPsolver1_solve(&params, &output, &info, mem, fp, pt2function_FORCESNLPsolver1);
