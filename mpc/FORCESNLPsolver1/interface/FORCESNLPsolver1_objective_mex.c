...
typedef FORCESNLPsolver1_float solver_float;
...
void copyCArrayToM_FORCESNLPsolver1(FORCESNLPsolver1_float *src, double *dest, solver_int32_default dim) 
{
...
void copyCValueToM_FORCESNLPsolver1(FORCESNLPsolver1_float* src, double* dest)
{
    *dest = (double)*src;
}

void copyMArrayToC_FORCESNLPsolver1(double *src, FORCESNLPsolver1_float *dest, solver_int32_default dim) 
{
    solver_int32_default i;
    for( i = 0; i < dim; i++ ) 
    {
        *dest++ = (FORCESNLPsolver1_float) (*src++) ;
    }
}

void copyMValueToC_FORCESNLPsolver1(double * src, FORCESNLPsolver1_float * dest)
{
	*dest = (FORCESNLPsolver1_float) *src;
}
...
extern solver_int32_default (FORCESNLPsolver1_float *x, FORCESNLPsolver1_float *y, FORCESNLPsolver1_float *l, FORCESNLPsolver1_float *p, FORCESNLPsolver1_float *f, FORCESNLPsolver1_float *nabla_f, FORCESNLPsolver1_float *c, FORCESNLPsolver1_float *nabla_c, FORCESNLPsolver1_float *h, FORCESNLPsolver1_float *nabla_h, FORCESNLPsolver1_float *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
FORCESNLPsolver1_extfunc pt2function_FORCESNLPsolver1 = &;
...
void mexFunction( solver_int nlhs, mxArray *plhs[], solver_int nrhs, const mxArray *prhs[] )  
{
    ...
    arr = prhs[0];
    copyMArrayToC_FORCESNLPsolver1(mxGetPr(arr), z, nvar);
    if (nrhs > 1)
	{
        arr = prhs[1];
        if ( !mxIsEmpty(arr) )
        {
            copyMArrayToC_FORCESNLPsolver1(mxGetPr(arr), p, dimp);
        }
	}   
	...
	copyCArrayToM_FORCESNLPsolver1(obj, mxGetPr(obj_mex), 1);
	copyCArrayToM_FORCESNLPsolver1(jacobj, mxGetPr(gradobj_mex), nvar);
	plhs[0] = obj_mex;
	plhs[1] = gradobj_mex;
