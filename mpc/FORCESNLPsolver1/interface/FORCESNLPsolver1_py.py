...
a Python wrapper for a fast solver generated by FORCESPRO v6.0.0
   ...
   OUTPUT = FORCESNLPsolver1_py.FORCESNLPsolver1_solve(PARAMS) solves a multistage problem
   ...
   [OUTPUT, EXITFLAG] = FORCESNLPsolver1_py.FORCESNLPsolver1_solve(PARAMS) returns additionally
   ...
   [OUTPUT, EXITFLAG, INFO] = FORCESNLPsolver1_py.FORCESNLPsolver1_solve(PARAMS) returns 
...
#_lib = ctypes.CDLL(os.path.join(os.getcwd(),'FORCESNLPsolver1/lib/FORCESNLPsolver1.so')) 
try:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolver1/lib/FORCESNLPsolver1_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolver1_solve')
except:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolver1/lib/libFORCESNLPsolver1_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolver1_solve')

internal_mem = getattr(_lib,'FORCESNLPsolver1_internal_mem')

class FORCESNLPsolver1_params_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESNLPsolver1_params = {'xinit' : np.array([]),
'x0' : np.array([]),
...
FORCESNLPsolver1_params_types = {'xinit' : np.float64,
'x0' : np.float64,
'all_parameters' : np.float64,
}

class FORCESNLPsolver1_outputs_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESNLPsolver1_outputs = {'x1' : np.array([]),
'x2' : np.array([]),
'x3' : np.array([]),
'x4' : np.array([]),
'x5' : np.array([]),
...
class FORCESNLPsolver1_info(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
class FORCESNLPsolver1_mem(ctypes.Structure):
    pass
...
csolver.argtypes = ( ctypes.POINTER(FORCESNLPsolver1_params_ctypes), ctypes.POINTER(FORCESNLPsolver1_outputs_ctypes), ctypes.POINTER(FORCESNLPsolver1_info), ctypes.POINTER(FORCESNLPsolver1_mem), ctypes.POINTER(FILE))
csolver.restype = ctypes.c_int

internal_mem.argtypes = [ctypes.c_uint]
internal_mem.restype = ctypes.POINTER(FORCESNLPsolver1_mem)

def FORCESNLPsolver1_solve(params_arg):
    '''
a Python wrapper for a fast solver generated by FORCESPRO v6.0.0
 ...
 See also COPYING
    ...
    # convert parameters
    params_py = FORCESNLPsolver1_params_ctypes()
    for par in params_arg:
        try:
            ...
            if isinstance(getattr(params_py, par), ctypes.Array):
                params_arg[par] = np.require(params_arg[par], dtype=FORCESNLPsolver1_params_types[par], requirements='F')
    ...
    outputs_py = FORCESNLPsolver1_outputs_ctypes()
    info_py = FORCESNLPsolver1_info()
    if sys.version_info.major == 2:
        ...
        try:
            PyFile_AsFile.restype = ctypes.POINTER(FILE)
            exitflag = _lib.FORCESNLPsolver1_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), PyFile_AsFile(fp) , _lib.FORCESNLPsolver1_adtool2forces )
        ...
        try:
            if sys.platform.startswith('win'):
                exitflag = _lib.FORCESNLPsolver1_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), None , _lib.FORCESNLPsolver1_adtool2forces)
            else:
                exitflag = _lib.FORCESNLPsolver1_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), fp , _lib.FORCESNLPsolver1_adtool2forces)
            libc.fclose(fp)
    ...
    # convert outputs
    for out in FORCESNLPsolver1_outputs:
        FORCESNLPsolver1_outputs[out] = npct.as_array(getattr(outputs_py,out))

    return FORCESNLPsolver1_outputs,int(exitflag),info_py

solve = FORCESNLPsolver1_solve
