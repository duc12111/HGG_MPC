...
class TestEnv(robot_env.RobotEnv, gym.utils.EzPickle):
    ...
    def _reset_sim(self):
        ...
        self.current_obstacle_vels = directions * self.np_random.uniform(2.0, 3.5, size=2)
    ...
    def render(self, mode='human', width=1080, height=1080):
        return super(TestEnv, self).render(mode, width, height)
