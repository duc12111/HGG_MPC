...
class FetchPickDynObstaclesRstopEnv(robot_env.RobotEnv, gym.utils.EzPickle):
    def __init__(self, reward_type='sparse', n_substeps=20):
        ...
        super(FetchPickDynObstaclesRstopEnv, self).__init__(
    ...
    def step(self, action):
        ...
        return super(FetchPickDynObstaclesRstopEnv, self).step(action)
    ...
    def render(self, mode='human', width=1080, height=1080):
        return super(FetchPickDynObstaclesRstopEnv, self).render(mode, width, height)
