...
class MPCControlGoalNoCollisionEnv(VanillaGoalEnv):
    total_reward = 0
    collisions = 0
    ...
    def _extend_reward(self, reward, obs):
        ...
        if obs['collision_check']:
            new_reward = -10.
        elif obs['object_dis'] > self.obj_distance_threshold:
            new_reward += -0.  # object is no more in the grip
